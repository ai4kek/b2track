#!/bin/bash
#SBATCH --job-name=b2track_raytune_optuna
#SBATCH --output=logs/raytune_optuna_%A_%a.out
#SBATCH --error=logs/raytune_optuna_%A_%a.err
...
# Run Ray Tune + Optuna optimization
...
python run_raytune_optuna.py --trials 100 --slurm --seed 42
